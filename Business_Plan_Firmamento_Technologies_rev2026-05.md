...
| Voce | Importo (EUR) |
|---|---|
| Impianti produttivi (stampanti 3D FDM materiali tecnici) | 6.000 |
| Altri impianti e attrezzature (workstation CFD, server hosting locale/AI) | 8.000 |
...
Firmamento risolve esattamente questo problema. La cooperativa è la **struttura abilitante** che agisce su tre leve:

1. **Unione e appartenenza.** Il ricercatore non è più un freelance isolato: entra in un corpo collettivo di pari, con voto per testa, co-proprietà e obiettivi condivisi. L'appartenenza abbatte l'isolamento che uccide la maggior parte delle iniziative individuali e riduce drasticamente il turnover (il socio è co-proprietario, non se ne va per un aumento del 10% altrove).
2. **Maturazione della fiducia.** La cooperativa fa "provare" i propri membri su commesse reali e progetti veri, in un ambiente protetto. Ogni commessa portata a termine, ogni prodotto rilasciato (vedi Fibonacci, infra) costruisce competenza imprenditoriale e fiducia nelle proprie capacità. Il ricercatore impara a essere imprenditore facendolo, con una rete che lo sostiene se sbaglia.
3. **Alleggerimento degli ostacoli.** Firmamento **centralizza ciò che frena il ricercatore**: amministrazione, contabilità, fatturazione, contrattualistica, compliance (GDPR, sicurezza, normativa di settore), gestione delle relazioni esterne (clienti, istituzioni, Legacoop, Coopfond, banche, bandi), infrastruttura tecnologica condivisa. Il socio si concentra sul valore tecnico; la cooperativa assorbe la frizione operativa e burocratica.
...
Firmamento opera su tre livelli: **servizi attivi** (generano ricavi e competenze), **prodotti scalabili** (ricavi ricorrenti e asset proprietari) e **progetti R&D** (asset a medio-lungo termine).
...
**Stato:** 1 modulo **live e in produzione** (Medicina Estetica), con demo pubblica accessibile senza registrazione; 5 specialità in **co-design** con cliniche partner (Dermatologia, Ortopedia, Psicologia, Nutrizione, Oculistica).

| Aspetto | Dettaglio |
|---|---|
| Cos'è | Cartella clinica elettronica (EMR) in cloud, multi-specialità, FHIR R4 nativo |
| Modello | SaaS B2B in abbonamento mensile, per studio/clinica |
| Differenziatore | Costruito in Italia per la pratica clinica reale; standard internazionali (FHIR R4, eIDAS) + sensibilità normativa italiana (consensi L. 219/2017, catalogo farmaci AIFA) |
| Funzione d'uso | Documentare una visita in ~3 minuti invece di 20 |
...
Firmamento combina **ricavi da progetto** (servizi, *value-based pricing*) e **ricavi ricorrenti** (abbonamenti Fibonacci), aumentando prevedibilità e scalabilità del fatturato.

**Listino servizi (Anno 1):**
- AI & Automation: € 5.000 – € 15.000 per progetto
- Simulazioni CFD: € 2.500 – € 7.000 per scenario
- Stampa 3D professionale: € 45 – € 80/ora
- Consulenza R&D: € 450 – € 650 per giornata-uomo

**Listino Fibonacci (SaaS, canone mensile, IVA esclusa):**

| Piano | € / mese (annuale) | Destinatario |
|---|---|---|
| Solo Pro | 149 | Medico singolo, studio mono-operatore |
| Studio | 349 | Studio 2–5 medici (più popolare) |
...
| | Anno 1 | Anno 2 | Anno a regime (A3) |
|---|---|---|---|
| Studi paganti (fine anno) | 14 | 52 | 148 |
| Studi medi attivi nell'anno | 7 | 33 | 100 |
| ARPA media (€/mese, al netto sconto Fondatori) | 180 | 200 | 233 |
| **Ricavi SaaS riconosciuti (€)** | **15.000** | **80.000** | **280.000** |
...
Le startup innovative italiane sono 11.090 a gennaio 2026 (−4,2%). Gli incentivi fiscali per startup innovative sono sospesi dal 1/1/2026 (EconomyUp, 2026): cambiamento che impatta il settore ma **non** il modello cooperativo di Firmamento, che beneficia di un quadro agevolativo distinto (legge sulle cooperative, Coopfond, sistema Legacoop). Non risulta alcuna cooperativa deep-tech attiva in Italia: categoria di fatto vuota.
...
**Stampa 3D:** 3DIngrolab (Genova), Astrati (Genova), Protolabs (USA/EU). *Limite vs Firmamento:* nessuna integrazione AI/CFD nel medesimo fornitore.
**AI/Consulenza:** Reply SpA (ricavi € 2,296 mld 2024). *Limite:* costi proibitivi per PMI, approccio generalista.
**CFD:** CFD FEA Service Srl (Verona), unico competitor OpenFOAM identificato. *Limite:* nessuna integrazione con AI o stampa 3D.
**EMR / software medico:** gestionali storici italiani e soluzioni internazionali. *Limite vs Fibonacci:* design datato o assenza di consensi normativi italiani, catalogo AIFA, AI di dettatura e FHIR R4 nativo.
**Venture building deep-tech:** Day One (Milano), Venturia (Milano). *Limite:* modello equity-based tradizionale, nessuna componente cooperativa, focus su startup esterne anziché sulla trasformazione di ricercatori in imprenditori.

#### Posizionamento competitivo

Il differenziatore non è un singolo servizio, ma il **modello**: una cooperativa deep-tech che fa da contesto-acceleratore per ricercatori-imprenditori e che ha già generato un prodotto SaaS sul mercato. Nessun competitor combina: (1) struttura cooperativa (allineamento incentivi, retention), (2) integrazione AI + Healthcare + Manufacturing + Engineering, (3) modello adattivo guidato dalle persone, (4) prodotti scalabili proprietari (Fibonacci) con ricavo ricorrente.

### B.4 Strategie commerciali

**Promozione.** Base di visibilità già costruita: ANSA (finanziamento Coopfond € 50.000 per H.A.L.E., 11/12/2025), La Repubblica, Legacoop nazionale, Coopfond, Telenord, Genova24, Primo Canale.
...
- **Stampa 3D:** acquisizione richiesta → progettazione/DfAM → slicing → stampa FDM → post-processing → QC → consegna.
- **AI:** assessment → design Private RAG → sviluppo (hosting locale Italia) → test/validazione → deploy → formazione → manutenzione ricorrente.
- **CFD:** definizione problema → geometria/mesh → setup solver OpenFOAM → calcolo → post-processing → report.
- **Fibonacci (SaaS):** discovery con medici reali → sviluppo modulo specialità → co-design con clinica partner → rilascio in produzione (CI/CD) → onboarding studio cliente → supporto e aggiornamenti continui (canone ricorrente). Infrastruttura cloud in UE; modelli AI (Mistral) ospitati in UE.
...
|---|---|---|
| A.1 | Parco stampanti 3D FDM: 2 unità professionali (PA-CF, ASA, ABS) + essiccazione filamenti | 6.000 |
| A.2 | Workstation CFD (OpenFOAM) + server dedicato hosting locale AI Private RAG | 8.000 |
| A.3 | Arredi: allestimento essenziale ufficio/laboratorio | 3.000 |
| B.1 | Beni immateriali: software, licenze, **dominio e marchio Fibonacci**, IP, certificazioni iniziali | 5.000 |
| | **TOTALE INVESTIMENTI** | **22.000** |
...
| Voce | Importo (EUR) |
|---|---|
| Investimenti in beni strumentali e immateriali | 22.000 |
...
### D.2 Conto economico previsionale triennale

Il conto economico integra ora i **ricavi ricorrenti SaaS** di Fibonacci e la corretta rilevazione del contributo Coopfond (voce A5).

| Voce | Anno 1 | Anno 2 | Anno a regime |
|---|---|---|---|
| **A) VALORE DELLA PRODUZIONE** | **101.000** | **206.000** | **462.000** |
| A.1 Servizi AI & Automation | 35.000 | 55.000 | 90.000 |
| A.2 Engineering & Simulazione CFD | 25.000 | 35.000 | 55.000 |
...
| B.3 Costo del personale / rimborsi soci | 42.000 | 88.000 | 205.000 |
| B.4 **Marketing e acquisizione clienti** | 7.000 | 20.000 | 48.000 |
| B.5 Ammortamenti asset materiali/immateriali | 4.000 | 6.000 | 16.000 |
| B.6 Costi R&D progetti proprietari (H.A.L.E.) | 12.000 | 14.000 | 3.000 |
| **DIFFERENZA A − B (EBIT)** | **8.000** | **28.000** | **92.000** |
| Imposte stimate (regime cooperativo agevolato, ~15% eff.) | 1.200 | 4.200 | 14.000 |
| **UTILE NETTO D'ESERCIZIO** | **6.800** | **23.800** | **78.000** |
...
### D.3 Analisi del punto di pareggio (Break-even)
...
Con ricavi da mercato Anno 1 di € 85.000, il margine di sicurezza è ~7%. L'Anno 1 è deliberatamente un **anno di investimento** (lancio SaaS + marketing), con il fabbisogno cuscinettato dal contributo a fondo perduto e dalla Riserva di Liquidità. Dall'Anno 2 l'operating leverage del SaaS abbassa strutturalmente il break-even relativo: il MdC dei ricavi ricorrenti è molto elevato e ogni euro oltre la soglia si converte rapidamente in utile.

### D.4 MOL (Margine Operativo Lordo / EBITDA)

| Voce | Anno 1 | Anno 2 | Anno a regime |
|---|---|---|---|
| Valore della produzione | 101.000 | 206.000 | 462.000 |
| Costi monetari (B.1+B.2+B.3+B.4+B.6) | 89.000 | 172.000 | 354.000 |
| **MOL (EBITDA)** | **12.000** | **34.000** | **108.000** |
| MOL % su VdP | 11,9% | 16,5% | 23,4% |

La crescita del MOL% riflette l'assorbimento dei costi fissi su volumi crescenti e, soprattutto, il peso crescente dei ricavi ricorrenti ad alto margine di Fibonacci.

### D.5 Indebitamento

Strategia improntata all'indipendenza dal debito bancario. **Debiti verso banche: € 0.** Gli investimenti (€ 22.000) e l'avvio sono coperti dal contributo a fondo perduto Coopfond e dal capitale sociale: la cooperativa nasce *debt-free*. Il fabbisogno corrente è gestito tramite autofinanziamento (MOL positivo già dall'Anno 1) e finanza agevolata mirata su R&D chiaramente definite. L'indice di indebitamento resta prossimo all'unità (attivo finanziato da capitale proprio e contributi), azzerando il rischio legato ai tassi.
...
### D.7 Liquidità aziendale nella fase di start-up (Anno 1)
...
### D.8 Posizione patrimoniale previsionale (sintetica, fine Anno 1)
...
**Costi fissi (annui, Anno 1):**

| Voce | Stima | Spiegazione |
|---|---|---|
| Affitto e utenze | € 9.600 | Sede, laboratorio, ufficio (elettricità, internet) |
| Cloud & infrastruttura SaaS | € 3.000 | Hosting UE (Hetzner), CDN/DNS (Cloudflare), monitoring Fibonacci |
| Software e amministrazione | € 6.400 | Commercialista, assicurazioni, licenze base |
| Marketing e acquisizione | € 7.000 | Sito, content, demo, canale partner, fondo imprevisti |
| Ammortamenti | € 4.000 | Quota su investimenti € 22.000 |
| **TOTALE COSTI FISSI** | **€ 30.000** | |

**Costi variabili diretti (annui, Anno 1):**

| Voce | Stima | Spiegazione |
|---|---|---|
| Materie prime e consumi | € 6.500 | Filamenti tecnici, resine, componenti |
| AI inference (uso) | € 1.000 | API Mistral (dettatura/consensi) proporzionale alle visite |
| Logistica e trasporti | € 500 | Spedizioni e trasferte implementazione |
| **TOTALE VARIABILI** | **€ 8.000** | |

**Personale e rimborsi soci (Anno 1):**

| Voce | Stima | Spiegazione |
|---|---|---|
| Indennità fissa soci | € 16.000 | Compenso base soci amministratori e presidio tecnico |
...
### Perché il contesto conta più del prodotto

Il modello tradizionale definisce prima il prodotto, poi cerca i clienti, poi assume le persone. Firmamento parte dall'**ostacolo che impedisce ai ricercatori italiani di diventare imprenditori** e lo rimuove costruendo il contesto:

1. **Unione** → un corpo cooperativo di pari, co-proprietà, voto per testa: appartenenza al posto dell'isolamento.
2. **Fiducia** → si diventa imprenditori provando, su commesse e prodotti reali, in un ambiente che sostiene anche l'errore.
3. **Alleggerimento** → la cooperativa centralizza burocrazia, fisco, contratti, compliance e relazioni esterne; il socio si concentra sul valore tecnico.

Il risultato è un ciclo virtuoso: **persone → contesto → competenze → prodotti e ricavi → attrazione di nuove persone.** Fibonacci ne è la prova vivente: un team di giovani ricercatori, abilitato da quel contesto, ha portato sul mercato un prodotto SaaS sanitario reale e fatturante.
...
|---|---|---|
| Sospensione incentivi startup (1/1/2026) | Limitato: la coop ha quadro agevolativo proprio | EconomyUp, 2026 |
| Calo startup innovative (−4,2%) | Opportunità: meno competizione per talenti e bandi | MIMIT, gen. 2026 |
| PNRR connettività € 3,8 mld | Opportunità diretta per H.A.L.E. (aree interne) | Italia Domani, PNRR |
